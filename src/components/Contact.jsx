...
function Contact() {
  return (
    <>
      <h1 className='text-3xl font-bold text-gray-900 dark:text-gray-600 text-center mt-5 mb-5'>Get in Touch with us</h1>
    
      <form class="max-w-sm mx-auto block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 ">
        ...
        <div data-popover="popover-description" class="hidden w-64 p-4 text-sm text-gray-500 bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700" role="dialog" aria-hidden="true">
          <p>This is a simple informational text that can help you with your form.</p>
        </div>
